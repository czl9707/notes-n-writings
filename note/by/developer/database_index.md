...
last-updated-date: 2026-01-04T16:45:50-05:00
aliases: [Index]
---

## How Database Store Data on Disk?

[Relational Database](note/by/developer/database_basic.md#Relational%20&%20Non-Relational%20Database) is a very good abstraction layer on top of underlying physical disk space. It is so good that we sometime forget it is actually still working with a **file system**.
...
Indexes do no harm on read operations, but might harm write operation in some cases.
