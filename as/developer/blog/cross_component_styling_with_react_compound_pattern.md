...
I will use CSS module as example for my personal perference 🙂.
...
We pushed the [Compound Pattern](https://www.notion.so/Breaking-Down-React-Components-From-Monolithic-to-Compound-Pattern-1d1f2d6bb3c580cca4b9c7ded3056651?pvs=21) to a bit further in this blog, which put forward an elegant solution for context-dependent styling in React. By providing explicit opt-in mechanisms for style behaviors, we maintain component independence while enabling rich interactions between components.
